...
//              bodyHTML: async.apply( bodyHTML, $ )
            ...
            function(err, result){
                ...
                var canonical = result.head.twetter.url
                    ||  result.head.og.url
                    || (result.head.links.canonical ? result.head.links.canonical.href : null )
                ;
  ...
  head_and_body: function(html, callback){
