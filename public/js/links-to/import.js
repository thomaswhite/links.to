    ...
    $('body')
        ...
        .on('change', 'input.excluded', function(event){
            ...
            socket.emit('imports:folder_exclude', {
                ...
                log ('import.folder_excluded:',  data);
        ...
        .on('click', '.import-btn', function(event){
            ...
            socket.emit('imports:process', {
                ...
                if (!response.success){
                    log('Bad import', response);
                }else{
                    log('Import started', response);
                    if( response.go_to ){
                        page(  response.go_to  );
                    }
                }
